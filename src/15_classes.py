...
test2 = Waypoint('place', 43, 131)
print(test2.name, test2.lat, test2.lon)
print()
...
test3 = Geocache('place', 'easy', 'small', 43, 131)
print(test3.name, test3.difficulty, test3.size, test3.lat, test3.lon)
